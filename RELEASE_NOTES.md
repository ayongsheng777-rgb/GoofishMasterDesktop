# GoofishMasterDesktop 闲鱼圣手桌面端 v1.0.0 发行说明
...
- 版本：`v1.0.0`（2026-08-06 发布，含安全加固与稳定性收尾）
- 安装包：`GoofishMasterDesktop-Setup-1.0.0.exe`
- 大小：约 580 MB（608,101,372 字节）
- SHA-256：`07a6b8e124434b7572a612b58e2656aabade1b29d005807269b508ded97244e1`
