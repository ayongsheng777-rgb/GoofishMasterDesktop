...
• 瑕疵词自动展开 — 「摔坏的手机」「坏的笔记本」会自动按瑕疵×设备交叉展开为多词采集
...
• 找 摔坏的手机 最近3天 — 瑕疵词展开 + 只采新发布
• 找 坏的 笔记本电脑 — 裸瑕疵词自动配对设备展开
• 结果列表"""
...
瑕疵词智能展开：
• 搜「摔坏的手机」「坏的笔记本」「屏幕破的平板」等瑕疵定语，自动按「瑕疵词 × 设备词」交叉展开为多词采集（如「摔坏的手机」→ 摔坏的iphone / 屏幕破的手机 / 摔坏的苹果手机）
• 裸瑕疵词「坏的」「摔坏」会自动配对常见设备（手机/iphone/笔记本/平板…）展开
• 口语/事件型表述也能识别（车压了 / 可乐倒了 / 键盘不能用 / 跑气 / 补了一块…），且会越用越懂（自动记忆新表述）
